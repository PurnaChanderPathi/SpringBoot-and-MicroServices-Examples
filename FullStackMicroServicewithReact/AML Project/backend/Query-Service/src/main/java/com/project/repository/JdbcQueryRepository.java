...
public class JdbcQueryRepository implements QueryRepository {
    ...
    public String save(QueryDetails queryDetails) {
        ...
        String lastReviewIdQuery = "SELECT reviewId FROM querydetails WHERE reviewId LIKE 'AML-" + currentDate + "-%' ORDER BY reviewId DESC LIMIT 1";
        ...
        String newReviewId = "AML-" + currentDate + "-001";
        ...
        if (lastReviewId != null) {
            ...
            newReviewId = "AML-" + currentDate + "-" + String.format("%03d", newNumericPart);
        }
