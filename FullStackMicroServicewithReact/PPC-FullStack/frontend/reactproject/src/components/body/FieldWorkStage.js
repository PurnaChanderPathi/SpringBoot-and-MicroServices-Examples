...
import { Margin, Token } from '@mui/icons-material';
...
const FieldWorkStage = ({ GroupNameToSpoc }) => {
    ...
    const handleDelete = (childReviewId) => {
    ...
    const handleObligorDelete = async (childReviewId) => {

        let url = `http://localhost:9195/api/ActionObligor/delete/${childReviewId}`;
                                                ...
                                                <div className='FieldworkSectionModal'>
                                                    ...
                                                    <div className='FieldWorkObligor'>
                                                        <div className='FieldWorkStageIP'>
                                                            ...
                                                            <TextareaAutosize minRows={21} style={{
