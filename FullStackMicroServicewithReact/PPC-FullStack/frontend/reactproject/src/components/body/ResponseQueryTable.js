...
import {
  setRowsPerPage,
  setTotalPages,
} from "../../redux/ResponseQueryFetchDetails";
...
const ResponseQueryTable = ({ isInserted, setIsInserted }) => {
  ...
  const updateResponseQueryDetails = async () => {
    const url =
      "http://localhost:9195/api/ActionObligor/updateResponseQueryDetails";
    const inputs = {
      response: response,
      responseBy: username,
  ...
  const ResponseQueryDeleteByQuerySequence = async (querySequence) => {
    ...
    try {
      ...
      if (response.data.status === 200) {
        console.log(
          "ResponseQuery Deleted Successfully :",
    ...
    <Box sx={{ padding: 2 }}>
      ...
      >
        ...
        >
          <Typography
            variant="body1"
            sx={{ marginRight: 1, color: "#0047AB", fontWeight: "bold" }}
          >
            selected rows
          </Typography>
          {/* <Select
          ...
          <Select
            ...
            sx={{
              ...
              "&.MuiOutlinedInput-root": {
                "& fieldset": {
                  border: "none", // Hides the border for the outlined variant
                },
                "&:hover fieldset": {
                  border: "none", // Hides border on hover
                },
              ...
              "& .MuiSelect-icon": {
                color: "#FF5E00", // Sets the color for the dropdown arrow icon
                // marginRight: "0px", // Optional: Adjust spacing
                gap:"10px"
              },
            }}
          >
        ...
        >
          <div style={{ display: "flex" }}>
            <Typography variant="body1" sx={{ marginX: 2 }}>
              {currentPage} - {Math.min(currentPage * rowsPerPage, rows.length)}{" "}
              of {rows.length}
            </Typography>
            ...
            //   disabled={currentPage === totalPages}
              ...
              startIcon={
                <ArrowForwardIosIcon sx={{ backgroundColor: "transparent" }} />
              }
            ></Button>
          </div>
        </Box>
      ...
      <Dialog open={isResponseQueryOpen} sx={{ marginBottom: "190px" }}>
        ...
        >
          ...
          >
            ...
            <Button onClick={handleResponseQueryCancel}>
          ...
          >
            <Typography sx={{ fontWeight: "bold" }}>
              ...
              you want to Delete Response Query ?
            </Typography>
          </div>
          <div
            style={{
          ...
          >
            <Button
              onClick={handleResponseQueryConfirm}
              variant="contained"
              size="small"
